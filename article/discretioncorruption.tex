...
\begin{titlepage}
\title{Estimating the Effect of Discretion in Public Spending on Corruption: Evidence from Brazilian Municipalities\thanks{The authors acknowledge valuable contributions from Sergio Firpo, Caio Costa, Vinicius Brunassi, Guilherme Lambais,
...
The remainder of this paper is organized as follows: section II presents similar studies and existing evidence on corruption determinants. Section III introduces our theoretical model, hypotheses, and estimation strategy. We present and discuss results in section IV. Section V concludes.
