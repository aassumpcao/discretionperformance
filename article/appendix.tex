...
it picks up both variations from the main keywords as well as coding
mistakes due to, for instance, multiple whitespace between the two
unigrams or when coding Portuguese special characters (adequação
\emph{vs} adequacao).
