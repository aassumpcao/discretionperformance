...
The last test of match quality compares the results of the classification algorithm against actual procurement violations reported by CGU auditors. Although section \@ref(quality2) supports external validity by comparing the results from searching in different textual descriptions, we can go one step further and actually look into service orders for which there were procurement violations and check whether they have also been identified as procurement-related.
