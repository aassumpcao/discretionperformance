...
\begin{table}[!htbp]
  \caption{\label{tab:workscutoff1} Discretion Effect on Mismanagement for Works Cutoff 1}
  \centering
  \begin{tabular}{c}
  \resizebox{.33\textwidth}{!}{\input{workscutoff11}}
  \resizebox{.33\textwidth}{!}{\input{workscutoff12}}
  \resizebox{.33\textwidth}{!}{\input{workscutoff13}}
  \end{tabular}
