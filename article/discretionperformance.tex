...
\begin{figure}[!htbp]
  \caption{\label{fig:manipulationtests} Manipulation Tests at SO Amounts} \centering
  \begin{tabular}{cc}
  \includegraphics[scale=.35]{purchasesmanipulation1} & \includegraphics[scale=.35]{worksmanipulation1} \\
  \includegraphics[scale=.35]{purchasesmanipulation2} & \includegraphics[scale=.35]{worksmanipulation2} \\
  \includegraphics[scale=.35]{purchasesmanipulation3} & \includegraphics[scale=.35]{worksmanipulation3} \\
  \end{tabular}
\end{figure}
