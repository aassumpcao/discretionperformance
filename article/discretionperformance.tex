...
\vspace{-10pt}
\input{../tables/corruptioncodes.tex}
\end{table}
...
\vspace{-10pt}
\input{../tables/auditbyministry.tex}
\end{table}
...
\vspace{-10pt}
\input{../tables/procurementtypes.tex}
\end{table}

\begin{figure}[ht]
\centering
\caption[figure1]{Corruption Determinants (Estimate and 95\% CIs)}\label{fig:corruptiondeterminants}
\floatfoot{Notes: This figure reports the point estimates of each corruption determinant (\emph{x}-axis) and their 95\% confidence intervals. These estimates come from an OLS regression of the binary corruption outcome and municipal controls, and ministry and lottery fixed-effects with robust standard errors clustered at the municipal level.}
\vspace{-10pt}
\includegraphics[scale = .8]{../plots/corr-determinats.pdf}
\end{figure}

\begin{table}[ht]
\centering
\caption[table4]{CCT Bandwidths}\label{tab:bandwidths}
\vspace{-10pt}
\input{../tables/bandwidth.tex}
\end{table}

\begin{table}[ht]
\centering
\caption{Means Tests \emph{p}-values Across Cutoffs}\label{tab:covariates}
\vspace{-10pt}
\input{../tables/covariates.tex}
\end{table}

\begin{table}[ht]
\centering
\caption{Multiple Non-Cumulative Cutoff Procurement Estimates}\label{tab:rdmc}
\vspace{-10pt}
\input{../tables/rdmc.tex}
\end{table}
