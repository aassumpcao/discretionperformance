...
\begin{figure}[!htbp]
  \caption{\label{fig:bandwidths} Discretion Point Estimates Across Cutoff 1 (Works SOs)}
  \centering
  \small
  \begin{tabular}{c}
  ...
  \multicolumn{1}{p{.6\textwidth}}{\scriptsize Notes:}
  \end{tabular}
\end{figure}
...
\begin{figure}[!htbp]
  \caption{Discretion Point Estimates Across Cutoff 1 (Non-Procurement SOs)}
  \label{fig:falsification1}
  \centering
  \small
  \begin{tabular}{c}
  \emph{Panel A: Mismanagement Binary} \\
  \includegraphics[scale = .15]{falsificationplot1} \\
  \emph{Panel B: Mismanagement Share} \\
  \includegraphics[scale = .15]{falsificationplot2} \\
  \emph{Panel C: Mismanagement Amount} \\
  \includegraphics[scale = .15]{falsificationplot3} \\
  \multicolumn{1}{p{.6\textwidth}}{\scriptsize Notes:}
  \end{tabular}
\end{figure}
