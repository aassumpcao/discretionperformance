...
\small
  \begin{tabular}{crr@{\extracolsep{6pt}}rr@{\extracolsep{6pt}}}
    ...
    \hline
    \multicolumn{5}{p{.5\textwidth}}{\footnotesize{Notes: All values have been rounded to zero decimal cases. The ranges have been determined by the average bandwidth across all six outcomes using the optimal bandwidth selection from \citet{CalonicoSebastianRobustNonparametricConfidence2014, CalonicoOptimalDataDrivenRegression2015, CattaneoInterpretingRegressionDiscontinuity2016}.}}
  \end{tabular}
\end{table}
