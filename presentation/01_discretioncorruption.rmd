...
Random sample of 9,593 federal transfers to 1,139 Brazilian municipalities to cover health and education expenditures for which we construct or collect data on:
...
Looking at federal transfers around whose values fall in the vicinities of the discontinuities in procurement rules allows for the identification of the **causal effect** of discretion on government performance.
